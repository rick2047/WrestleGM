## 1. Implementation
- [x] 1.1 Add WrestlerDefinition fields (description, avatar_path) in data model and loader with safe defaults.
- [x] 1.2 Add Wrestler View widget with configurable blocks and avatar fallback handling.
...
## 3. Docs
- [x] 3.1 Update documentation to reflect new minimum viewport target and booking UI behavior.

## 4. Validation
- [x] 4.1 Run `openspec validate update-booking-ui-wrestler-view --strict`.
- [x] 4.2 Run `uv run pytest` (or targeted UI tests if available).
