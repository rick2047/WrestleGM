...
- [x] 1.4 Remove `RatingDebug` usage and update related tests.
- [x] 1.5 Update PRD/spec docs if needed to reflect the unified modifier flow and debug payload changes.
- [x] 1.6 Run all tests and ensure they pass.
